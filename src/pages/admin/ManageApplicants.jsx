  ...
  <div className="flex-1 bg-gray-100 pl-4 sm:pl-6 pr-4 py-6 overflow-auto min-h-screen">
    ...
    <div className="max-w-7xl mx-auto bg-white rounded-md shadow-md p-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <h1 className="text-2xl font-semibold text-gray-800">Manage Applicants</h1>
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
          <button
            ...
            title={selectedApplicants.size === applicants.length ? "Deselect All" : "Select All"}
          >
            <span className="mr-2">+</span>
            <span>{selectedApplicants.size === applicants.length ? "Deselect All" : "Select All"}</span>
          </button>
          <button
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="text-gray-800 font-semibold">{applicant.name}</p>
